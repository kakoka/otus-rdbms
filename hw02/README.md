...
UUID | varchar(50) | uuid_generate_v1() | NO |
...
UUID | varchar(50) | uuid_generate_v1()| NO | уникальный идентификатор сотрудника
